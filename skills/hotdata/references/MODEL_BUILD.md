...
When suggesting a new index, use the same connection/schema/table/column names as in `tables list` and the core **`hotdata`** / **`hotdata-analytics`** `indexes create` examples (bm25/vector vs sorted).
